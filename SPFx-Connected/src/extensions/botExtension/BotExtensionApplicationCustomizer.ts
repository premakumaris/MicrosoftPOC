...
const LOG_SOURCE: string = 'BotExtensionApplicationCustomizer';
import * as strings from 'BotExtensionApplicationCustomizerStrings';
 ...
 */
export interface IBotExtensionApplicationCustomizerProperties {
...
export default class BotExtensionApplicationCustomizer
  extends BaseApplicationCustomizer<IBotExtensionApplicationCustomizerProperties> {
 ...
 public _openChat(): void {
     ...
     let _that: BotExtensionApplicationCustomizer = jQuery("#bot").data("ref");
             ...
             if (this._bottomPlaceholder.domElement) {
                 this._userLoaded.then((upnString) => { // 2019-06-17 PD Render only after we've gotten the current user's UPN (to support persistent cookie in atbot)
                     ...
                     <div id="chatWindow" class="chat-window" style="display:none;">
                         <div class="ms-bgColor-themeDark heading"> <a>Test</a>
